...
#include <netinet/in.h>// 用于网络编程
#include <unistd.h>// 提供了对POSIX操作系统API的访问

#include "common/ini_setting.h"// 用于处理INI配置文件
#include "common/init.h"// 初始化函数
#include "common/lang/iostream.h"// 输入输出流
#include "common/lang/string.h"// 字符串操作
#include "common/lang/map.h"// 映射容器
#include "common/os/process.h"// 进程相关操作
#include "common/os/signal.h"// 信号处理
#include "common/log/log.h"// 日志系统
#include "net/server.h"// 服务器类
#include "net/server_param.h"// 服务器参数

using namespace common;

#define NET "NET"// 定义一些常量和全局变量

static Server *g_server = nullptr;// 服务器实例的全局指针

void usage()// 打印使用说明的函数
{
  cout << "Usage " << endl;// 打印出程序的使用说明
...
// 主函数 用于启动服务器，设置信号处理，解析参数，初始化服务器，并开始服务
